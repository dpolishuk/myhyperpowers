...
This skill wraps the source file `agents/review-simplification.md` for Codex Skills compatibility.

## Usage

- Use this skill when the request matches the intent of `agents/review-simplification.md`.
