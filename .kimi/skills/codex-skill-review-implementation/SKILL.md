...
description: "Use when the original skill 'review-implementation' applies. Use after xpowers:executing-plans completes all tasks - verifies implementation against the epic spec, all success criteria met, anti-patterns avoided"
---
