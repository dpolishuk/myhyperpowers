---
name: codex-agent-devops
description: "Use when delegating to agent 'devops' is needed. Avoid for direct implementation tasks."
---

# Codex Agent Wrapper

This skill wraps the source file `agents/devops.md` for Codex Skills compatibility.

## Usage

- Use this skill when the request matches the intent of `agents/devops.md`.
