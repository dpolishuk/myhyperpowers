---
name: codex-skill-refactoring-diagnosis
description: "Use when the original skill 'refactoring-diagnosis' applies. Use when identifying bad code/design and selecting refactor targets - produces a diagnosis report with smells, risks, and refactor vs rewrite decision"
---

<!-- Generated from skills/refactoring-diagnosis/SKILL.md -->
