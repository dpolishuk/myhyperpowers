---
name: codex-agent-codebase-investigator
description: "Use when delegating to agent 'codebase-investigator' is needed. Avoid for direct implementation tasks."
---

# Codex Agent Wrapper

This skill wraps the source file `agents/codebase-investigator.md` for Codex Skills compatibility.

## Usage

- Use this skill when the request matches the intent of `agents/codebase-investigator.md`.
