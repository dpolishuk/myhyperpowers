---
name: codex-skill-subagent-driven-development
description: "Use when the original skill 'subagent-driven-development' applies. Use to define the canonical 'Dispatch Protocol' for stateless orchestration via fresh subagents."
---
