...
This skill wraps the source file `agents/test-runner.md` for Codex Skills compatibility.

## Usage

- Use this skill when the request matches the intent of `agents/test-runner.md`.
