...
This skill wraps the source file `agents/internet-researcher.md` for Codex Skills compatibility.

## Usage

- Use this skill when the request matches the intent of `agents/internet-researcher.md`.
